...
// Function to build up the draw or discard pile with cards
void buildPile(List<Widget> pileElements, int cards, bool isDiscardPile,
...
// Function to add a card to the draw or discard pile
void addCard(List<Widget> pileElements, bool isDiscardPile,
...
// Function to remove a card from the draw or discard pile
void removeCard(List<Widget> pileElements) {
