...
// Function to build up the liberal or fascist board with all cards
List<Widget> buildBoard(bool isLiberal, List<Widget> boardElements,
...
void addCard(List<Widget> boardElements, List<double> cardPositions,
